...
CLS
cl:
PRINT "This is JT's code program 2.0"
PRINT

INPUT "Enter which code you want (1 or 2)"; choice
IF choice = 1 THEN GOTO bc
...
PRINT
aa:
INPUT "Do you want to go to the main menu(1), quit(2), try again(3), clear the         screen(4), or open a file(5)"; choice
IF choice = 1 THEN GOTO cl
IF choice = 2 THEN GOTO quit
IF choice = 3 THEN GOTO cl8
IF choice = 4 THEN CLS
IF choice = 5 THEN GOTO oj
GOTO an
...
oj:
PRINT
INPUT "Enter the file to decode >", b$
