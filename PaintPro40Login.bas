...
LET AMOUSE$ = "YES"
mouseshow
OPEN "c:\wolflogn\temp.tmp" FOR INPUT AS #1
INPUT #1, username$
CLOSE #1
g = 15
wanted$ = CHR$(219)
...
NEXT i
COLOR 15
LOCATE 22, 10: PRINT "PaintPro v. " + version$ + " for WOLF LOGIN  (c)WolfWare Interactive '98"
SLEEP
clearer:
FOR i = 1 TO 22
FOR j = 1 TO 80
...
CLS
COLOR 15
PRINT "What filename do you want to save it as?"
PRINT "Example: picture1"
INPUT ">", name$
CLS
OPEN "c:\wolflogn\" + username$ + "\" + name$ + ".ppf" FOR OUTPUT AS #1
FOR i = 1 TO 22
FOR j = 1 TO 80
PRINT #1, a(i, j)
NEXT j
...
CLS
COLOR 15
PRINT "What filename are you opening?"
PRINT "Example: picture1"
INPUT ">", name$
OPEN "c:\wolflogn\" + username$ + "\" + name$ + ".ppf" FOR INPUT AS #1
FOR i = 1 TO 22
FOR j = 1 TO 80
INPUT #1, a(i, j)
NEXT j
...
GOTO looper1
goon:
PRINT "What filename do you want for the QBasic source code?"
PRINT "Example: picture1"
INPUT ">", place$
OPEN "c:\wolflogn\" + username$ + "\" + place$ + ".bas" FOR OUTPUT AS #1
PRINT #1, "CLS"
PRINT #1, "DIM a(22,80)"
PRINT #1, place$ + ":"
FOR i = 1 TO 22
